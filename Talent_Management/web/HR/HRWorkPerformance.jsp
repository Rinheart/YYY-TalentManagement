...
<form class="col-12" action="AddAttend" method="post">
    ...
    出勤异常的事件：
    <select class="form-control col-6" name="newAttend.event">
        <option value="0">旷工</option>
        <option value="1">请假</option>
        <option value="2">迟到</option>
        <option value="3">早退</option>
    </select><br>
    出勤异常日期：<input class="form-control col-6" type="date" name="p_date" />
...
<form class="col-12" action="AddDisciplinary" method="post">
    ...
    违纪事件描述：<input class="form-control col-6" type="text" name="p_content" /><br>
    违纪发生日期：<input class="form-control col-6" type="date" name="p_date" /><br>
    <input type="submit" class="col-6 btn btn-outline-primary"/>
</form>
<br>
<h4>违纪事件</h4>
...
<form class="col-12" action="AddReward" method="post">
    <input type="hidden" name="p_talentId" value="${p_talentId}" />
    奖励名称：<input class="form-control col-6" type="text" name="p_rewordName" /><br>
    获奖原因：<input class="form-control col-6" type="text" name="p_rewordResult" /><br>
    奖品：<input class="form-control col-6" type="text" name="p_prize" /><br>
    获奖日期：<input class="form-control col-6" type="date" name="p_date" /><br>
    <input type="submit" class="col-6 btn btn-outline-primary" />
</form>
<br>
<h4>奖励事件</h4>
...
<form class="col-12" action="AddBigEvent" method="post">
    <input type="hidden" name="p_talentId" value="${p_talentId}" />
    事件描述：<input class="form-control col-6" type="text" name="p_content" /><br>
    发生日期：<input class="form-control col-6" type="date" name="p_date" /><br>
    <input type="submit" class="col-6 btn btn-outline-primary" />
</form>
<br>
<h4>重大事件</h4>
